		...
		try {
            ...
            dha.sendMessage(anu.jid, 'Halo! Terima Kasih sudah Mengundangku, Jika ingin Menggunakan Bot Ketik ${prefix}menu', 'conversation')
             ...
             if (!welkom.includes(anu.jid)) return
	            ...
	            buff = await getBuffer(` https://bx-hunter.herokuapp.com/api/canvas/welcome?apikey=FuckBitch&nama=${anu-user}&gc=${encodeURI(mdata.subject)}&member=${memeg&ppgc=${pp_group}&pp=${pp_user&bg=https://i.ibb.co/f0s6m4V/20211219-143708.jpg`)
                ...
                buttonsMessage = { contentText: `${teks}`, footerText: 'Baca deskripsi dulu ya pren', imageMessage: imageMsg, buttons: buttons, headerType: 4 }
