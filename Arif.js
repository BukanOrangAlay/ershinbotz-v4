...
//ೋ❀❀ೋ═══[SUBSCRIBE Arif OFFICIAL]═══ೋ❀❀ೋ//
// stickwm
...
module.exports = Arif = async (Arif, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Arif.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "COPYRIGHT © 2022 P3MU14-UI . ALL REVERSE","listType": "SINGLE_SELECT","sections": list}}, {})
...
❏ RUN IN : *『> HEROKU <』*
❏ THANKS TO  : *『> Arif , LEXXY AND ALL CREATOR <』*
...
*[Wait] Tunggu Sebentar..*`
             ...
             Arif.sendMessage(from, buffer2, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
             break  
				case 'play':
              if (!q) return reply('Linknya?')
...
❏ RUN BOT : HERO KU
❏ MODEL SC : JSON KEY
❏ THANKS TO : Arif OFC , LEXXY OFC , AND ALL CREATOR BOTZ
*━━━━━━━━━━━━━━━━━━━━*`)
     case 'allmenu':
...
reply = fs.readFileSync('./media/ara2.mp3');
             Arif.sendMessage(from, reply, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
             break
//--------------<fitur tambahan>--------------
case 'tes':
reply(`Bot aktif om🗿`)
