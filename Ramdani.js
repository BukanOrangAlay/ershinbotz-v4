	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/Ramdani3.jpg`)},"title": `© ᴄʀᴇᴀᴛᴏʀ ʙʏ ʀᴀᴍᴅᴀɴɪ ᴏғғɪᴄɪᴀʟ⸙`,"description": "Ramdani Official", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Ramdani Official","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
❏ RUN BOT : HERO KU
❏ MODEL SC : JSON KEY
❏ THANKS TO : RAMDANI OFC , LEXXY OF , AND ALL CREATOR BOTZ
*━━━━━━━━━━━━━━━━━━━━*`)
     case 'allmenu':
