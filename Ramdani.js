...
case 'sholawat4':
             ...
             break
 case 'randomsholawat'
  const rsholawat =['./media/sholawat.mp3','./media/sholawat1.mp3','./media/sholawat2.mp3','./media/sholawat3.mp3','./media/sholawat4.mp3']
  const rasholawat = rsholawat[Math.floor(Math.random() * rsholawat.length)]
  ransholawat = fs.readFileSync(rasholawat);
  Ramdani.sendMessage(from, ransholawat, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
