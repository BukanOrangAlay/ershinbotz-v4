...
🎉🎊🥳🎊🎉🥳🎊🎉🥳🎊🎉🥳`
        ...
        case 'command':
               list = []
               listmenu = [`soundmenu`,`selamat`,`groupmenu`,`wibumenu`,`stickermenu`,`islammenu`,`sertimenu`,`ceritamenu`,`makermenu`,`sholawatmenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`toolsmenu`,`infobot`,`owner`,`buttonstik`,`buttondl`,`buttosound`,`buttonown`,`buttonpen`,`buttongame`,`buttongc`]
               listmenuu = [`Sound Menu`,`Tahun Baru`,`Menu Group`,`Wibu Menu`,`Sticker Menu`,`Islam Menu`,`Serti Menu`,`Cerita Menu`,`Maker Menu`,`Sholawat Menu`,`Owner Menu`,`Game Menu`,`Fun Menu`,`Downloader`,`Info Menu`,`MenuLainnya`,`Tools Menu`,`Info Bot`,`Owner`,`Stiker Menu`,`Dowload Menu`,`Owner Menu`,`Nulis Menu`,`Game Menu`,`Grup Menu`]
               nombor = 1
               startnum = 0
